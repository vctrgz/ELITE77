            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(top: 33.0), // Ajusta el valor según el margen que desees
                    ...
                    _buildExpansionTile(
                      ...
                      imageUrl: "lib/assets/images/menu/PHOTO-2025-03-02-21-36-25.jpg",
                      index: 0,
                    ),
                    _buildExpansionTile(
                      title: "HIIT",
            ...
            child: ValueListenableBuilder<bool>(
              ...
              builder: (context, isExpanded, child) {
                return ExpansionTile(
                  ...
                  title: Text(
                    title,
                    style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white, fontFamily: 'Agdasima'),
                  ),
                  children: [
                    Container(
                      ...
                      child: Text(
                        content.trim(),
                        style: const TextStyle(fontSize: 16, color: Colors.white, fontFamily: 'Agdasima'),
                      ),
                    ),
                  ],
                );
